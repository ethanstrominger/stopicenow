...
function insertSiteTitle() {
  ...
  container.innerHTML = `
    <div style="text-align:center; background:#fff;">
      <h1 style="font-family: 'Times New Roman', Times, serif; font-size:2.5em; color:#b30000; font-weight:900; margin-bottom:0.1em; margin-top:0; letter-spacing:0.01em;">FIX ICE</h1>
